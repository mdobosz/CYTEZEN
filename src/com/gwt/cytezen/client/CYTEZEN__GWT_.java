 ...
 */
public class CYTEZEN__GWT_ implements EntryPoint {    
    ...
    public void onModuleLoad() {
        ...
        if (null != error && error.equals("user_denied")) {
            ...
            messageBox = MessageBox.wait("CYTEZEN", "", "Generating friend \"FacialPrints\"...");
    ...
    private void userDenied() {
        MessageBox.confirm("Error authorizing CYTEZEN",
                "You have deined CYTEZEN from installing correctly, click 'Yes' to try again",
