...
import com.gwt.cytezen.client.GoogleService;
import com.gwt.cytezen.server.google.ResponseDataContainer;
...
public class GoogleServiceImpl extends RemoteServiceServlet implements GoogleService {
    ...
    public Long findFriendRanking(final FbFriend friend) {
        ...
        try {
            ...
            logger.warn("Could not find an entry for {} in the datastore.", friend.getId());
    ...
    public Long findResultCount(final String name) {
        ...
        logger.info("Executing google query {}", queryUrl);
